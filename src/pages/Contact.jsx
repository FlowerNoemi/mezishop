        ...
        <div className='backgroundContact'  >
            {success ? (
             <div className='ContactDiv'>
                 ...
                 <img src={loginlogo} loading='lazy' alt='Mézishop logó' title='Mézishop logó' className='imgLogoContact' />
                 </div>
                <section className='contactBox '>
                    <h1>Sikeres üzenetküldés! </h1>
                        <p>Hamarosan jelentkezünk!</p>
                        <div className='btnBox'>
                         <MyButtonmedium onClick={() => navigate('/termekek')}  value='Irány a shop!'
                         className='loginBtn'></MyButtonmedium>
                         </div>
                </section>
                </div>  
            ) : (<>
                  ...
                  <div className='ContactDivCont1'>
                            ...
                            <Stack >
                                <List >
                                    <ListItem  >
                                        <ListItemAvatar>
                                            <Avatar sx={{ color: 'black', background: 'linear-gradient(45deg, #E18D00 0%, #E8C07A  51%, #E18D00  100%)'}} >
                                                <CallIcon />
                                            </Avatar>
                                        </ListItemAvatar>
                                        <ListItemText 
                                     ...
                                     primary='Hívjon bizalommal!' secondary='+36307774447'  />
                                    </ListItem>
                                    <ListItem>
                                        <ListItemAvatar>
                                            <Avatar sx={{ color: 'black', background: 'linear-gradient(45deg, #E18D00 0%, #E8C07A  51%, #E18D00  100%)'}} >
                                    ...
                                    sx={{ 
                                     ...
                                     primary='Küldjön e-mailt!' secondary='testmail@gmail.com' />
                                    </ListItem>
                                    <ListItem>
                                        <ListItemAvatar>
                                            <Avatar sx={{ color: 'black', background: 'linear-gradient(45deg, #E18D00 0%, #E8C07A  51%, #E18D00  100%)'}} >
                                        ...
                                        sx={{ 
                                         ...
                                         primary='Jöjjön el hozzánk!' secondary='4002, Tesz-Vesz Város Teszt út 10' />
                                        </ListItem>
                                    </List>
                            </Stack>  
                        </div>
                <div className='ContactDivCont2'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='btnBox'>
                            <MyButtonmedium disabled={!validEmail || !validMessage ? true : false} value='Küldés'
                            className='loginBtn' 
                            ></MyButtonmedium>
                            </div>
                        </form>
